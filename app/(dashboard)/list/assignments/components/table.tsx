...
const COLUMNS = [
  { key: 'subject', label: 'Subject', render: (assignment: Assignment) => assignment.subject.name },
  { key: 'class', label: 'Class', render: (assignment: Assignment) => assignment.class.name },
  {
    key: 'teacher',
    label: 'Teacher',
